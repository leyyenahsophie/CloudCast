"""
Django settings for cloudcast project.
...
ALLOWED_HOSTS = [
    'cloudcast-app-fyftcxergtbxekff.eastus-01.azurewebsites.net',
    '127.0.0.1',
    'localhost',
]
...
WSGI_APPLICATION = 'cloudcast.wsgi.application'
